        ...
        <div class="space-y-6">
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-50 bg-gray-50/50">
                    <h2 class="text-xs font-black uppercase tracking-[0.2em] text-gray-400">01. Informasi Pribadi</h2>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-50 bg-gray-50/50">
                    <h2 class="text-xs font-black uppercase tracking-[0.2em] text-gray-400">02. Detail Akademik & Waktu Magang</h2>
                </div>
