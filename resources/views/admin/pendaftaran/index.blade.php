...
@section('content')
    <div class="max-w-6xl mx-auto">
        <div class="flex justify-between items-end mb-10">
            <div>
                <h1 class="text-2xl font-black text-gray-900 uppercase tracking-tighter">Kelola Pendaftar</h1>
                ...
                <div class="flex flex-wrap gap-3 mb-6">
                    ...
                    <a href="{{ route('admin.export.pdf') }}"
                        class="flex items-center gap-2 bg-red-600 text-white px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-red-700 transition-all shadow-lg shadow-blue-600/20">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
