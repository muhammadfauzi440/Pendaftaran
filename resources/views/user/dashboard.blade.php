                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex justify-between border-b border-gray-50 pb-3">
                                        ...
                                        <span class="text-gray-900 font-black text-sm">
                                            {{ \Carbon\Carbon::parse($pendaftaran->tanggal_mulai)->format('d M') }} - {{ \Carbon\Carbon::parse($pendaftaran->tanggal_selesai)->format('d M Y') }}
                                        </span>
                                    </div>
                                    <div class="pt-4">
                                        <a href="/user/daftar" class="text-xs font-black text-red-600 hover:text-red-700 uppercase tracking-widest border-b-2 border-red-100">
                                            Lihat Detail &rarr;
                                        </a>
                                    </div>
                                </div>
